...
function HistoryArrowIcon({ direction }: { direction: "undo" | "redo" }) {
  return direction === "undo"
    ? <svg className="uie-history-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M4 8h7.5a8 8 0 1 1-6.2 13"/><path d="M7.5 4.5 4 8l3.5 3.5"/></svg>
    : <svg className="uie-history-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 8h-7.5a8 8 0 1 0 6.2 13"/><path d="M16.5 4.5 20 8l-3.5 3.5"/></svg>;
}
