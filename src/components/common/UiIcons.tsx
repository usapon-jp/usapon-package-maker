...
export function PreviewIcon(props: IconProps) { return <Icon {...props}><rect x="3" y="6" width="15" height="15" rx="2.5"/><path d="m6.5 17 3.2-3.4 2.4 2.3 2.3-2.5 3.6 3.7M18.5 2v6M15.5 5h6"/></Icon>; }
